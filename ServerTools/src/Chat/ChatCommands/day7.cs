...
namespace ServerTools
{
    public class Day7
    {
        ...
        public static void GetInfo(ClientInfo _cInfo, bool _announce)
        {
            ...
            int _daysUntil7 = GameUtils.WorldTimeToDays(_worldTime);
            int z = 0;
            ...
            foreach (Entity _e in _entities)
            {
                ...
                if (_name == "zombie01" || _name == "zombie04" || _name == "zombieScreamer" ||
                    _name == "zombieBoe" || _name == "zombieJoe" || _name == "zombieMoe" || _name == "zombieYo" ||
                    _name == "zombieSteve" || _name == "zombieSteveCrawler" || _name == "zombieNurse" ||
                    _name == "zombieDarlene" || _name == "zombieArlene" || _name == "zombieMarlene" ||
                    _name == "snowzombie" || _name == "spiderzombie" || _name == "burntzombie")
                {
                    _zombies = _zombies + 1;
                }
            ...
            string _phrase301 = "The next 7th day will be on Day {DaysUntil7}";
            ...
            if (_announce)
            {
                ...
                GameManager.Instance.GameMessageServer(_cInfo, string.Format("[FF8000]{0}[-]", _phrase301), "Server");
            ...
            else
            {
                ...
                _cInfo.SendPackage(new NetPackageGameMessage(string.Format("[FF8000]{0}[-]", _phrase301), "Server"));
