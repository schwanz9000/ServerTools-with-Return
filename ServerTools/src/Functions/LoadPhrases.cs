        ...
        public static void UpdatePhrases()
        {
            ...
            using (StreamWriter sw = new StreamWriter(_filepath))
            {
                ...
                else
                {
                    ...
                    sw.WriteLine("        <!-- ******************************************************** -->");
                    sw.WriteLine("        <!-- *********************** SetReturn ********************** -->");
                    sw.WriteLine("        <!-- ******************************************************** -->");
                    sw.WriteLine("        <Phrase id=\"15\" Phrase=\"{PlayerName} you already have a return set.\" />");
                    sw.WriteLine("        <Phrase id=\"16\" Phrase=\"{PlayerName} your return has been saved.\" />");
                    sw.WriteLine("        <Phrase id=\"17\" Phrase=\"{PlayerName} you do not have a return saved.\" />");
                    sw.WriteLine("        <Phrase id=\"18\" Phrase=\"{PlayerName} your return has been removed.\" />");
                    sw.WriteLine("        <Phrase id=\"19\" Phrase=\"{PlayerName} you can only use /return once every {DelayBetweenUses} minutes. Time remaining: {TimeRemaining} minutes.\" />");
                    sw.WriteLine("        <!-- ******************************************************** -->");
